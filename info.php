...
$update = array(
    ...
    "sections" => [
        ...
        "changelog" => "<h4>Mise à jour du 7 juin 2024</h4><ul>
            <li>Diverses améliorations technique</li>
            <li>[TEST] Traduction des contenus du plugin ACF</li>
            <li>[TEST] Ajout du système de traduction de contenus multiples</li>
        </ul>",
    ]
);
