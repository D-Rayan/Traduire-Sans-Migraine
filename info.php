...
$update = array(
    ...
    "sections" => [
        ...
        "changelog" => "<h4>Mise à jour du 20 Novembre 2024</h4><ul>
        <li>Fix : Ne tentons plus de dupliquer les médias quand ils proviennent d'une source externe ce qui pourrait provoquer une erreur</li>
        </ul><h4>Mise à jour du 19 Novembre 2024</h4><ul>
        <li>Fix : Correction d'un problème lors d'une erreur non controlé dans l'affichage de la file d'attente</li>
